...
const getDepartments = require('./routes/department');
const addRoleToDataBase = require('./routes/role');
...
async function addRole() {
  try {
    ...
    const { names, objects } = await getDepartments();
    ...
    await addRoleToDataBase(roleData);
